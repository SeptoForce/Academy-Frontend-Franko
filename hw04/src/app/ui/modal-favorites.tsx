...
export const FavoritesModal = (props: {
	...
	return props.isOpen ? (
		...
		>
			<div
				className={clsx(
					"fixed left-1/2 top-14 z-40 inline-grid h-[calc(100dvh-4rem)] w-[calc(100vw-1rem)] max-w-7xl -translate-x-1/2 grid-flow-row grid-cols-1 justify-items-center gap-6 overflow-x-hidden overflow-y-scroll rounded-xl bg-white p-4 sm:top-1/2 sm:h-auto sm:max-h-[calc(100vh-8rem)] sm:min-h-64 sm:w-[calc(100vw-16rem)] sm:-translate-y-1/2 lg:grid-cols-2 xl:grid-cols-3 dark:bg-header-dt",
				)}
