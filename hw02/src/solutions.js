module.exports = {
   ...
   */
  fibonacciNumbers(n) {
    if (n <= 0) return undefined; // case for n 0 and below
  ...
  /* 
    To be honest I didn't know the solution since I didn't really need to use IIFEs in my previous projects. I guess it's a cool trick to know.
  */
};
